...
async function fetchTotalSpent() {
    const response = await fetch('/family/dashboard_family/total_spent_family/');
    const Data = await response.json();
    console.log(Data)
    document.getElementById("total-spent-family").innerText = Data
    return Data;
}

async function fetchTotalBalance() {
    const response = await fetch('/family/dashboard_family/current_balance_family/');
    const Data = await response.json();
    console.log(Data)
...
async function fetchTotalremaining() {
    const response = await fetch('/family/dashboard_family/fixed_fees_remaining_family/');
    const Data = await response.json();
    console.log(Data)
...
async function fetchStatus() {
    const response = await fetch('/family/dashboard_family/this_month_status_family');
    const Data = await response.json();
    console.log(Data)
...
async function fetchSpent() {
    const response = await fetch('/family/dashboard_family/spent_trend_family');
    const Data = await response.json();
    console.log(Data)
    return Data;
}
async function fetchSpentPercentage() {
    const response = await fetch('/family/dashboard_family/this_month_spent_percentage_family');
    const Data = await response.json();
    console.log(Data)
    return Data;
}
...
async function fetchTransData() {
    const response = await fetch('/family/dashboard_family/this_month_trans_family');
    const Data = await response.json();
    console.log(Data)
    return Data;
}
...
async function fetchsubcatData() {
    const response = await fetch('/family/dashboard_family/this_month_spent_sub_categ_percentage_family');
    const Data = await response.json();
    console.log(Data)
    return Data;
}
async function fetchsubcatDataInverse() {
    const response = await fetch('/family/dashboard_family/this_month_spent_sub_categ_percentage_inverse_family');
    const Data = await response.json();
    console.log(Data)
    return Data;
}
...
async function initGrid() {
    ...
    const gridOptions = {
        ...
        columnDefs: [
            { field: "family_member", filter: true},
