...
document.getElementById('save_btn').addEventListener('click', () => {
  ...
  const Description_column_name = document.getElementById(
    'Description_column_name',
  ).value;
  const Amount_column_name =
    document.getElementById('Amount_column_name').value;
  const account_name_mapping = document.getElementById(
...
async function file_mapping_fn(
  Date_column_name,
  Description_column_name,
  Amount_column_name,
  account_name_mapping,
