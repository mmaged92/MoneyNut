async function fetchTotalSpent() {
  const response = await fetch(
    window.moneyNutUrl('/expense/dashboard/total_spent'),
  );
...
async function fetchTotalBalance() {
  const response = await fetch(
    window.moneyNutUrl('/expense/dashboard/current_balance'),
  );
  const Data = await response.json();
  console.log(Data);
...
async function fetchTotalremaining() {
  const response = await fetch(
    window.moneyNutUrl('/expense/dashboard/fixed_fees_remaining'),
  );
  const Data = await response.json();
  console.log(Data);
...
async function fetchStatus() {
  const response = await fetch(
    window.moneyNutUrl('/expense/dashboard/this_month_status'),
  );
  const Data = await response.json();
  console.log(Data);
...
async function fetchSpent() {
  const response = await fetch(
    window.moneyNutUrl('/expense/dashboard/spent_trend'),
  );
  const Data = await response.json();
  console.log(Data);
  return Data;
...
async function fetchSpentPercentage() {
  const response = await fetch(
    window.moneyNutUrl('/expense/dashboard/this_month_spent_percentage'),
  );
  const Data = await response.json();
  console.log(Data);
  return Data;
...
async function fetchTransData() {
  const response = await fetch(
    window.moneyNutUrl('/expense/dashboard/this_month_trans'),
  );
  const Data = await response.json();
  console.log(Data);
  return Data;
...
async function fetchsubcatData() {
  const response = await fetch(
    window.moneyNutUrl(
      '/expense/dashboard/this_month_spent_sub_categ_percentage',
    ),
  );
  const Data = await response.json();
  console.log(Data);
...
async function fetchsubcatDataInverse() {
  const response = await fetch(
    window.moneyNutUrl(
      '/expense/dashboard/this_month_spent_sub_categ_percentage_inverse',
    ),
  );
  const Data = await response.json();
  console.log(Data);
