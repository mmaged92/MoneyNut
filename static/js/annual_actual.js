...
async function fetchData() {
  try {
    const response = await fetch(
      window.moneyNutUrl('/expense/annual_view/annual_get_actual'),
    );
    if (!response.ok) {
...
async function fetchSpentData() {
  const response = await fetch(
    window.moneyNutUrl('/expense/annual_view/annual_spent/'),
  );
  const Data = await response.json();
  return Data;
}
...
async function fetchTargetData() {
  const response = await fetch(
    window.moneyNutUrl('/expense/annual_view/annual_target/'),
  );
  const Data = await response.json();
  return Data;
}
...
async function fetchIncomeData() {
  const response = await fetch(
    window.moneyNutUrl('/expense/annual_view/annual_income/'),
  );
  const Data = await response.json();
  return Data;
}
...
async function fetchSavingActualData() {
  const response = await fetch(
    window.moneyNutUrl('/expense/annual_view/annual_saving/'),
  );
  const Data = await response.json();
  return Data;
}
...
async function fetchSavingTargetData() {
  const response = await fetch(
    window.moneyNutUrl('/expense/annual_view/annual_saving_target/'),
  );
  const Data = await response.json();
  return Data;
}
async function fetchAnnualBalanceData() {
  const response = await fetch(
    window.moneyNutUrl('/expense/annual_view/balance_track_annual/'),
  );
  const Data = await response.json();
  console.log(Data);
  return Data;
