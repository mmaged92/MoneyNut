async function fetchData() {
  const reponse = await fetch(window.moneyNutUrl('/saving/income/income_get'), {
    method: 'GET',
  });
...
async function fetchfreq() {
  const reponse = await fetch(
    window.moneyNutUrl('/saving/income/income_freq_get'),
    { method: 'GET' },
  );
...
async function confirm_delete_income(income_id) {
  ...
  const response = await fetch(
    window.moneyNutUrl('/saving/income/delete_income'),
    {
      method: 'DELETE',
      headers: {
...
async function income_update(newValue, income_id) {
  const response = await fetch(
    window.moneyNutUrl('/saving/income/income_update'),
    {
      method: 'PUT',
      headers: {
        'X-CSRFToken': getCookie('csrftoken'),
...
async function freq_update(newValue, income_id, year, month) {
  ...
  const response = await fetch(
    window.moneyNutUrl('/saving/income/income_freq_update'),
    {
      method: 'PUT',
      headers: {
        'X-CSRFToken': getCookie('csrftoken'),
...
async function date_update(newValue, income_id) {
  ...
  const response = await fetch(
    window.moneyNutUrl('/saving/income/income_date_update'),
    {
      method: 'PUT',
      headers: {
        'X-CSRFToken': getCookie('csrftoken'),
