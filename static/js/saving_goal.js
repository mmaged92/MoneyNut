async function fetchData() {
  const reponse = await fetch(window.moneyNutUrl('/saving/goal/goal_get'), {
    method: 'GET',
  });
...
async function getAccounts() {
  const response = await fetch(
    window.moneyNutUrl('/saving/goal/get_accounts'),
    { method: 'GET' },
  );
...
async function goal_name_update(newValue, goal_id) {
  const response = await fetch(
    window.moneyNutUrl('/saving/goal/goal_name_update'),
    {
      method: 'PUT',
      headers: {
        'X-CSRFToken': getCookie('csrftoken'),
...
async function goal_account_update(newValue, goal_id) {
  const response = await fetch(
    window.moneyNutUrl('/saving/goal/goal_account_update'),
    {
      method: 'PUT',
      headers: {
        'X-CSRFToken': getCookie('csrftoken'),
...
async function goal_target_update(newValue, goal_id) {
  const response = await fetch(
    window.moneyNutUrl('/saving/goal/goal_target_update'),
    {
      method: 'PUT',
      headers: {
        'X-CSRFToken': getCookie('csrftoken'),
...
async function goal_due_date_update(newValue, goal_id) {
  ...
  const response = await fetch(
    window.moneyNutUrl('/saving/goal/goal_due_date_update'),
    {
      method: 'PUT',
      headers: {
        'X-CSRFToken': getCookie('csrftoken'),
