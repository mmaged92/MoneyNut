...
async function fetchData() {
  const reponse = await fetch(window.moneyNutUrl('/target/targetinsert/all'), {
    method: 'GET',
  });
...
async function fetchfreq() {
  const reponse = await fetch(
    window.moneyNutUrl('/target/targetinsert/freqget'),
    { method: 'GET' },
  );
...
async function confirm_delete_target(target_id) {
  ...
  const response = await fetch(
    window.moneyNutUrl('/target/targetinsert/delete'),
    {
      method: 'DELETE',
      headers: {
...
async function category_update_target(newValue, category_id, target_id) {
  const response = await fetch(
    window.moneyNutUrl('/target/targetinsert/category_update_target'),
    {
      method: 'PUT',
      headers: {
        'X-CSRFToken': getCookie('moneynut_csrftoken'),
...
async function tagert_update(newValue, target_id) {
  const response = await fetch(
    window.moneyNutUrl('/target/targetinsert/target_update'),
    {
      method: 'PUT',
      headers: {
        'X-CSRFToken': getCookie('moneynut_csrftoken'),
...
async function freq_update(newValue, target_id, year, month) {
  const response = await fetch(
    window.moneyNutUrl('/target/targetinsert/freq_update'),
    {
      method: 'PUT',
      headers: {
        'X-CSRFToken': getCookie('moneynut_csrftoken'),
...
async function date_update(newValue, target_id) {
  const response = await fetch(
    window.moneyNutUrl('/target/targetinsert/date_update'),
    {
      method: 'PUT',
      headers: {
        'X-CSRFToken': getCookie('moneynut_csrftoken'),
