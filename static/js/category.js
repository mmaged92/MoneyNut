async function fetchcategories() {
  const response = await fetch(window.moneyNutUrl('/target/category_get/'));
  const category_list = await response.json();
  return category_list;
}
async function fetchmaincategories() {
  const response = await fetch(
    window.moneyNutUrl('/target/main_category_get/'),
  );
  const category_list = await response.json();
...
async function fetchmaincategorieslist() {
  const response = await fetch(
    window.moneyNutUrl('/target/main_category_get_list/'),
  );
  const category_list = await response.json();
  console.log(category_list);
  return category_list;
...
async function main_category_update_main(new_value, category_id) {
  const response = await fetch(
    window.moneyNutUrl('/target/main_category_update/'),
    {
      method: 'PUT',
      headers: {
...
async function main_category_update(new_value, category_id) {
  const response = await fetch(
    window.moneyNutUrl('/target/category_main_category_update/'),
    {
      method: 'PUT',
      headers: {
        'X-CSRFToken': getCookie('csrftoken'),
...
async function fixed_fees_update(new_value, category_id) {
  ...
  const response = await fetch(
    window.moneyNutUrl('/target/fixed_fees_update/'),
    {
      method: 'PUT',
      headers: {
        'X-CSRFToken': getCookie('csrftoken'),
...
async function main_confirm_delete(category_id) {
  ...
  // const reqBody = {keyword_id}
  const response = await fetch(
    window.moneyNutUrl('/target/main_category_delete/'),
    {
      method: 'DELETE',
      headers: {
        'X-CSRFToken': getCookie('csrftoken'),
...
async function initGrid() {
  ...
  const myGridElementMainCategories = document.querySelector(
    '#myGridmaincategories',
  );
  gridApiMainCategories = agGrid.createGrid(
    myGridElementMainCategories,
    gridOptionMainCategories,
  );
...
document
  .getElementById('deleteallmaincategory')
  .addEventListener('click', () => {
    const selectedData = gridApiMainCategories
      .getSelectedRows()
...
async function submitmaincategory(newCategory) {
  const response = await fetch(
    window.moneyNutUrl('/target/main_category_add/'),
    {
      method: 'PUT',
      headers: {
        'X-CSRFToken': getCookie('csrftoken'),
...
document.getElementById('sendButton').addEventListener('click', () => {
  const main_category_get = document.getElementById(
    'main-category-value',
  ).value;
