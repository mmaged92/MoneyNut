async function fetchData() {
  const response = await fetch(window.moneyNutUrl('/accounts/getaccounts'), {
    method: 'GET',
  });
...
async function fetchBank() {
  const response = await fetch(window.moneyNutUrl('/accounts/bank_get'), {
    method: 'GET',
  });
  const data = await response.json();
  return data;
...
async function fetchAccountsTypes() {
  const response = await fetch(
    window.moneyNutUrl('/accounts/accounttype_get'),
    { method: 'GET' },
  );
  const data = await response.json();
  return data;
...
async function account_type_update(newValue, account_id) {
  const response = await fetch(
    window.moneyNutUrl('/accounts/accounttype_update/'),
    {
      method: 'PUT',
      headers: {
        'X-CSRFToken': getCookie('csrftoken'),
...
async function account_name_update(newValue, account_id) {
  const response = await fetch(
    window.moneyNutUrl('/accounts/accountname_update/'),
    {
      method: 'PUT',
      headers: {
        'X-CSRFToken': getCookie('csrftoken'),
...
async function account_number_update(newValue, account_id) {
  const response = await fetch(
    window.moneyNutUrl('/accounts/accountnumber_update/'),
    {
      method: 'PUT',
      headers: {
        'X-CSRFToken': getCookie('csrftoken'),
...
async function Starting_balance_update(newValue, account_id) {
  const response = await fetch(
    window.moneyNutUrl('/accounts/accountbalancestart_update/'),
    {
      method: 'PUT',
      headers: {
        'X-CSRFToken': getCookie('csrftoken'),
...
async function account_balance_update(newValue, account_id) {
  const response = await fetch(
    window.moneyNutUrl('/accounts/accountbalance_update/'),
    {
      method: 'PUT',
      headers: {
        'X-CSRFToken': getCookie('csrftoken'),
...
async function account_balance_date_update(newValue, account_id) {
  const response = await fetch(
    window.moneyNutUrl('/accounts/account_date_update/'),
    {
      method: 'PUT',
      headers: {
        'X-CSRFToken': getCookie('csrftoken'),
