async function category_view_send(category_view) {
  const response = await fetch(
    window.moneyNutUrl('/family/monthly_view/category_get_view/'),
    {
      method: 'POST',
      headers: {
...
async function fetchData() {
  try {
    const response = await fetch(
      window.moneyNutUrl('/family/monthly_view/monthly_get'),
    );
    if (!response.ok) {
...
async function fetchCategorySpentData() {
  const response = await fetch(
    window.moneyNutUrl('/family/monthly_view/category_spent/'),
  );
  const Data = await response.json();
  return Data;
}
async function fetchCategorySpentDataamounts() {
  const response = await fetch(
    window.moneyNutUrl('/family/monthly_view/category_spent_amounts/'),
  );
  const Data = await response.json();
  return Data;
}
...
async function fetchdailyspent() {
  const response = await fetch(
    window.moneyNutUrl('/family/monthly_view/category_spent_daily/'),
  );
  const Data = await response.json();
  return Data;
}
...
async function spentvstarget() {
  const response = await fetch(
    window.moneyNutUrl('/family/monthly_view/spentvstarget/'),
  );
  const Data = await response.json();
  return Data;
}
...
async function incomeVSspent() {
  const response = await fetch(
    window.moneyNutUrl('/family/monthly_view/incomevsspent/'),
  );
  const Data = await response.json();
  return Data;
}
...
async function targetVSsaving() {
  const response = await fetch(
    window.moneyNutUrl('/family/monthly_view/savingvstarget/'),
  );
  const Data = await response.json();
  return Data;
}
...
async function Balance() {
  const response = await fetch(
    window.moneyNutUrl('/family/monthly_view/balance_track_monthly/'),
  );
  const Data = await response.json();
  return Data;
}
