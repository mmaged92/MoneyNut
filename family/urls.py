...
urlpatterns = [
    ...
    path('annual_view/annual_target_view_fam',views.annual_target_view_fam, name="annual_target_view_family"),
    ...
    path('annual_view',views.annual_actual_view_fam, name="annual_actual_view_family"),
    ...
    path('annual_view/balance_track_annual/',views.balance_track_annual_fam, name="balance_track_annual_family"),
